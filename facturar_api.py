...
from google_drive_client import upload_pdf_to_drive  # 👈 NUEVO
...
async def facturar(req: FacturaRequest):
  ...
  try:
    ...
    # 4) Registrar factura en JSON (incluyendo datos de Drive)
    ...
    # 5) Leer PDF local para mandarlo también en base64 (por ahora lo mantenemos igual)
    ...
    return {
      ...
      "cbte_nro": cbte_nro,
      "pdf_base64": pdf_b64,
      "pdf_url": drive_url,  # 👈 por si después querés usarlo directo
    }
